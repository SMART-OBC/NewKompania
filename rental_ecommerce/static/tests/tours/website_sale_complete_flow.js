odoo.define('rental_ecommerce_tour.tour', function (require) {
    'use strict';

    var tour = require("web_tour.tour");
    var rpc = require("web.rpc");

    tour.register('rental_ecommerce_tour', {
        test: true,
        url: '/rent?search=Storage Box Test',
    }, [
    ...
    },
    {
        ...
        run: function () {
            ...
            def2.then(function () {
                window.location.href = '/web/session/logout?redirect=/rent?search=Storage Box Test';
            });
        },
    },
    ...
    },
    {
        ...
        trigger: '.one_kanban form[action^="/rent/address"] .btn',
    },
    {
        content: "Fulfill shipping address form",
        trigger: 'select[name="country_id"]',
    ...
    },
    {
        ...
        extra_trigger: '.oe_cart .oe_rental_ecommerce_tx_status',
    ...
    },
    {
        ...
        run: function () {
            $('.oe_login_form input[name="login"]').val("admin");
            $('.oe_login_form input[name="password"]').val("admin");
            $('.oe_login_form input[name="redirect"]').val("/rent/cart");
            $('.oe_login_form').submit();
        },
    },
    {
    ...
    },
    {
        ...
        run: function () {
            $('.oe_login_form input[name="login"]').val("abc@odoo.com");
            $('.oe_login_form input[name="password"]').val("1admin@admin");
            $('.oe_login_form input[name="redirect"]').val("/rent?search=Storage Box Test");
            $('.oe_login_form').submit();
        },
    },
    {
