odoo.define('rental_ecommerce.tour_shop_deleted_archived_variants', function (require) {
'use strict';
...
tour.register('tour_shop_deleted_archived_variants', {
    test: true,
    url: '/rent?search=Test Product 2',
},
[
    {
        content: "check price on /rent (template price)",
