odoo.define('rental_ecommerce.tour', function (require) {
'use strict';
...
tour.register('shop_buy_product', {
    ...
    [
        ...
        },
        {
            ...
            trigger: '#product_detail form[action^="/rent/cart/update"] .btn-primary',
        },
        {
        ...
        {
            content: "finish",
            trigger: '.oe_rental_ecommerce:contains("Please make a payment to:")',
            // Leave /rent/confirmation to prevent RPC loop to /rent/payment/get_status.
