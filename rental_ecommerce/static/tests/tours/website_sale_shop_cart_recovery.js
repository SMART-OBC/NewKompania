odoo.define('rental_ecommerce.tour_shop_cart_recovery', function (require) {
'use strict';
...
var orderIdKey = 'rental_ecommerce.tour_shop_cart_recovery.orderId';
var recoveryLinkKey = 'rental_ecommerce.tour_shop_cart_recovery.recoveryLink';

tour.register('shop_cart_recovery', {
    test: true,
    url: '/rent?search=Acoustic Bloc Screens',
},
[
    {
