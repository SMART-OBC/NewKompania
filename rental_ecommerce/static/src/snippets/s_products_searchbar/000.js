odoo.define('rental_ecommerce.s_products_searchbar', function (require) {
'use strict';
...
publicWidget.registry.productsSearchBar = publicWidget.Widget.extend({
    ...
    xmlDependencies: ['/rental_ecommerce/static/src/xml/rental_ecommerce_utils.xml'],
    events: {
    ...
    _fetch: function () {
        return this._rpc({
            route: '/rent/products/autocomplete',
            params: {
                'term': this.$input.val(),
                'options': {
                    'order': this.order,
    ...
    _render: function (res) {
        ...
        if (res) {
            ...
            this.$menu = $(qweb.render('rental_ecommerce.productsSearchBar.autocomplete', {
                products: products,
