odoo.define('rental_ecommerce.validate', function (require) {
'use strict';
...
publicWidget.registry.websiteSaleValidate = publicWidget.Widget.extend({
    selector: 'div.oe_rental_ecommerce_tx_status[data-order-id]',
    ...
    _paymentTransationPollStatus: function () {
        var self = this;
        this._rpc({
            route: '/rent/payment/get_status/' + parseInt(this.$el.data('order-id')),
