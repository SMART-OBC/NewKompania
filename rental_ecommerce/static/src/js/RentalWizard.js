odoo.define('rental_ecommerce.RentalWizard', function (require) {
...
publicWidget.registry.RentalWizardSnippet = publicWidget.Widget.extend({
//    selector: '.s_wsale_products_recently_viewed',
    xmlDependencies: ['/rental_ecommerce/static/src/xml/RentalWizard.xml'],
...
//    _fetch: function () {
//        return this._rpc({
//            route: '/rent/products/recently_viewed',
//        }).then(res => {
...
//    },
    ...
    _render: function (res) {
        ...
        this.mobileCarousel = $(qweb.render('rental_ecommerce.RentalWizard', {
            uniqueId: this.uniqueId,
            productFrame: 1,
            productsGroups: mobileProducts,
        }));
        this.webCarousel = $(qweb.render('rental_ecommerce.RentalWizard', {
            uniqueId: this.uniqueId,
            productFrame: 4,
    ...
    _onRemove: function (ev) {
        ...
        var $card = $(ev.currentTarget).closest('.card');
        this._rpc({
            route: "/rent/products/recently_viewed_delete",
            params: {
                product_id: $card.find('input[data-product-id]').data('product-id'),
            },
        }).then(function (data) {
...
publicWidget.registry.RentalWizardUpdate = publicWidget.Widget.extend({
    ...
    _updateProductView: function ($input) {
        ...
        this._rpc({
            route: '/rent/products/recently_viewed_update',
            params: {
