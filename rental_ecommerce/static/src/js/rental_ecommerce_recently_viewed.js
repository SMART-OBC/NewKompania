odoo.define('rental_ecommerce.recently_viewed', function (require) {
...
publicWidget.registry.productsRecentlyViewedSnippet = publicWidget.Widget.extend({
    ...
    xmlDependencies: ['/rental_ecommerce/static/src/xml/rental_ecommerce_recently_viewed.xml'],
    ...
    _render: function (res) {
        ...
        this.mobileCarousel = $(qweb.render('rental_ecommerce.productsRecentlyViewed', {
            uniqueId: this.uniqueId,
            productFrame: 1,
            productsGroups: mobileProducts,
        }));
        this.webCarousel = $(qweb.render('rental_ecommerce.productsRecentlyViewed', {
            uniqueId: this.uniqueId,
            productFrame: 4,
