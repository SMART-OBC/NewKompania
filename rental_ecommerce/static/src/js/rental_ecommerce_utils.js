odoo.define('rental_ecommerce.utils', function (require) {
'use strict';
    ...
    return new Promise(function (resolve, reject) {
        ...
        if ($imgtodrag.length) {
            var $imgclone = $imgtodrag.clone()
                ...
                .addClass('o_rental_ecommerce_animate')
...
function updateCartNavBar(data) {
    ...
    $(".js_cart_lines").first().before(data['rental_ecommerce.cart_lines']).end().remove();
    $(".js_cart_summary").first().before(data['rental_ecommerce.short_cart_summary']).end().remove();
}
