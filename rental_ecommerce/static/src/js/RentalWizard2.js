...
//        const xmlDependencies = ['/website_rentals/static/src/xml/RentalWizard.xml'];
//        static template = "website_rentals.RentalWizard";
        ...
        setup() {
            useExternalXml(["/website_rentals/static/src/xml/RentalWizard.xml"]);
        }
    ...
    RentalWizard.template = 'website_rentals.RentalWizard';
    return RentalWizard;
});
