odoo.define('rental_ecommerce.add_product', function (require) {
'use strict';
...
odoo.define('rental_ecommerce.editor', function (require) {
'use strict';
...
options.registry.WebsiteSaleProductsItem = options.Class.extend({
    xmlDependencies: (options.Class.prototype.xmlDependencies || []).concat(['/rental_ecommerce/static/src/xml/rental_ecommerce_utils.xml']),
    ...
    async _renderCustomXML(uiFragment) {
        ...
        Object.values(this.ribbons).forEach(ribbon => {
            const colorClasses = ribbon.html_class
                ...
                .join(' ');
            $select.append(qweb.render('rental_ecommerce.ribbonSelectItem', {
                ribbon,
                colorClasses,
